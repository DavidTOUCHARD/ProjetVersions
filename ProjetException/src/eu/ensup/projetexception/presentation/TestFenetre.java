package eu.ensup.projetexception.presentation;
...
import eu.ensup.projetexception.service.AvengerService;


public class TestFenetre extends JComponent{
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Comparaison de deux avengers ");
		service.ComparerAvenger(av1, av2) ;
		System.out.println("Ajout de l'avenger suivant : "+av2);
